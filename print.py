...
[imageWidth, imageHeight] = background_image.size

newimageWidth = int(imageWidth*n)
if same:
    newimageHeight = int(imageHeight*n)
else:
    newimageHeight = int(imageHeight/n)

background_image = background_image.resize(
    (newimageWidth, newimageHeight), Image.ANTIALIAS)
